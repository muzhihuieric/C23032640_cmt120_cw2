...
def fake_admin():
    admin = Admin(
        username='admin',
        blog_title='Blog',
        blog_sub_title="There's nothing I want to say",
        name='Personal blog',
...
def fake_comments(count=500):
    sites = ['https://twitter.com/elonmusk', 'https://twitter.com/haydaypop', 'https://twitter.com/hayday']
    for i in range(count):
        comment = Comment(
            author=fake.name(),
            email=fake.email(),
...
def fake_links():
    twitter = Link(name='Twitter', url='https://www.twitter.com/')
